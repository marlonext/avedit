// ActivDoc.cpp : implementation of the CActiveXDocTemplate CActiveXDocControl class.
//
            ...
            pViewClass)
{
  ...
  m_pMainDlg = new CMainDialog(m_pFrameWnd);
  if (m_pMainDlg)
  {
    BOOL bRet = m_pMainDlg->Create(IDD_DIALOG_MAIN);
        ...
        CFrameWnd* pOther)
{
  ...
  if (!m_pFrameWnd->Create(NULL, "", WS_CHILD|WS_VISIBLE,
      CFrameWnd::rectDefault, /*m_pParentWnd*/m_pMainDlg, NULL, 0, &context))
  {
      TRACE0("Warning: CDocTemplate couldn't create a frame.\n");
      return NULL;
  }

	m_pFrameWnd->ShowWindow(SW_HIDE);

  m_pMainDlg->UpdateFrameWnd(m_pFrameWnd);
  ::PostMessage(m_pMainDlg->GetSafeHwnd(), WM_SIZE, NULL, NULL);
